...
id: gear/equipment/shields-basics
category: [core]
type: rule
...
Most physical shields are one-handed items. Some require that they are attached to the forearm, while others are simply held. Details are included in each description.