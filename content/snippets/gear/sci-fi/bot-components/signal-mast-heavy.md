...
id: gear/sci-fi/bot-components/signal-mast-heavy
category: [sci-fi]
type: equipment
...
Any character using the [Companion Bot](/docs/free-srd/character-creation/abilities/sci-fi/#companion-bot) ability who has a Signal Mast, Heavy installed on their companion can issue commands and receive updates at its full range.
