...
A restrained limb cannot be used to make attacks, hold or manipulate items, or perform actions that require that limb. A character with a restrained arm cannot use two-handed weapons or items requiring both hands. A character with restrained legs has their speeds reduced to 0 but may still crawl at half their base speed. Attackers gain advantage against a restrained character when the restrained body part would otherwise help them evade or defend.
