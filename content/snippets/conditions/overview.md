...
| [Crippled](#crippled) | All speeds -10, +1 Stress if using 3+ AP — attackers gain minor advantage | Until wound is healed |
| [Dying](#dying) | FORT check each turn (starts at 3, +1/round) — failure or damage means death | Until healed, or death |
| [Fatigued](#fatigued) | -2 STR, AGI, and DEX, -2 AP/round | Until rested |
...
| [Prone](#prone) | Half speed, minor disadvantage on melee attacks — adjacent attackers gain minor advantage | Until standing |
| [Restrained](#restrained) | Physical actions limited — affected limb unusable | Until cause is removed |
...
| [Unconscious](#unconscious) | Cannot take any actions — attackers gain minor advantage and surprise | Cause specific |
