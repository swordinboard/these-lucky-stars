...
Characters who have not yet had their first turn in initiative are considered out of combat and are vulnerable to [surprise attacks](/docs/free-srd/core-rules/combat/#surprise-attacks).

> *An exception to the tie breaker rule:*
> In an initiative tie between opponents, the group that initiated combat goes first. If neither belings to an initiatong group, resopve normally. In a tie between allies, the players decide the order and may change it from round to round.
