...
id: rules/environment/extreme-environments
category: [core]
type: rule
...
The GM sets the interval based on proximity and intensity: **1 round** for direct contact or close proximity, **1 minute** for ambient exposure, or longer for low-level unavoidable hazards like residual radiation.
