...
summary: "Single-seat patrol fighter. Size 6, very fast, thin plate, an ejection seat that gets used."
---

{{% statblock type="Spacecraft — Size 6 (6 spaces)" %}}
Thirty feet of engine with a cockpit bolted to the front of it. An interceptor
exists to be somewhere else within the minute, and every kilo of plate it does
