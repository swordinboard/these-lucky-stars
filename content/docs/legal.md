...
The following content is part of the SRD and covered by CC BY-NC-SA 4.0:
...
**You CAN:**
- Run These Lucky Stars games for your friends
- Post session reports and actual play content
- Create homebrew content for personal use
- Share house rules on forums or social media
- Make character sheets and reference tools (non-commercial)
- Create fan content and share it freely
- Write blog posts or reviews about the system
- Link to or reference these rules in your own free RPG content

**You CANNOT (without permission):**
- Sell These Lucky Stars content or derivatives
- Use "These Lucky Stars" name/logo for commercial products
- Republish the complete setting guide or paid content
- Create commercial products (paid PDFs, apps, etc.) using this system
- Remove attribution to These Lucky Stars or Sword in Board Workshop
- Claim you created the These Lucky Stars system

## Commercial Use & Partnerships

Interested in creating commercial content compatible with These Lucky Stars? We're open to partnerships and licensing arrangements.

Contact us at: **info@theseluckystars.com**

## Attribution Guidelines

When using or sharing These Lucky Stars content, please include:

**Minimum attribution:**
> Based on These Lucky Stars by Sword in Board Workshop  
> Licensed under CC BY-NC-SA 4.0  
> https://theseluckystars.com
...
Have questions about what you can or can't do with These Lucky Stars content? Contact us at **info@theseluckystars.com** - we're happy to help.
