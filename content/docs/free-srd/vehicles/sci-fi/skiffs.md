...
{{% include "/snippets/statblocks/sci-fi/vehicles/skiff-utility" %}}

{{% include "/snippets/statblocks/sci-fi/vehicles/skiff-hauler" %}}

{{% include "/snippets/statblocks/sci-fi/vehicles/skiff-runner" %}}
...
**Hauler** trades every kind of agility for mass. Four spaces of collision dice is genuinely dangerous, and four spaces of length means a turn radius that has the driver committing to a route several rounds before it matters. These are most often reserved for long drives or constant slow-crawl circuits within large yards or compounds to avoid tight turn arounds.

**Runner** is the chase vehicle. It reaches the Fast tier where the others cannot, and its Object DEF of 12 means it may not survive using that speed badly — a wall ends the scene rather than the round. These are best reserved for couriers and personnel transport in locations that require creative solutions from limited resources.