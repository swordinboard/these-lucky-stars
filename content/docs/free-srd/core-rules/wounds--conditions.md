...
| Wound Type | Minor Example | Major Example | Common Conditions |
|---|---|---|---|
| [Burn](#burn) | Surface burn, mild chemical exposure | Deep tissue burn, severe chemical exposure | +1 Stress until dressed |
| [Contusion](#contusion) | Severe bruise, bruised rib | Deep tissue damage, internal bleeding | Crippled |
| [Dislocation](#dislocation) | Dislocated finger or wrist | Dislocated shoulder, hip, knee, or elbow | Crippled or Restrained |
| [Fracture](#fracture) | Hairline fracture, cracked rib | Compound fracture, shattered bone | Shaken, +1 Stress — may add Bleeding, Crippled, or Confused |
| [Laceration](#laceration) | Shallow cut, minor slash wound | Deep gash, severed tissue | Bleeding |
...
|---|---|---|
| Stabbed, shot, or slashed (physical) | Puncture, Laceration | Bleeding |
| Bashed, struck with a blunt object (physical) | Contusion, Dislocation, Fracture | Shaken, Crippled |
| Thrown or pushed, knocked prone (physical) | Contusion, Fracture, Sprain | Shaken, Crippled |
