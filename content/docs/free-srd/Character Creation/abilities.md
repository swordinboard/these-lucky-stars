...
{{% details title="Charge" open=false %}}
### Charge
...
{{% details title="Agile Charge" open=false %}}
### Agile Charge
...
When activating the Powerful Rage ability, roll an intimidation check. All opponents within 30ft must succeed on a contested WILL check against your intimidation check. Those who fail their check gain 1 point of Stress.
